...
def partition_workload(time_until_deadline, swiftclient, container_name, file_list = None):
    ...
    for video in file_list:
        ...
        if (prediction_time > time_until_deadline):
            print "WARNING:  ONE OF THE FILES (%s) IS TOO BIG TO BE TRANSCODED IN TIME. YOU MAY NOT REACHT THE DEADLINE. Maybe cut it up into chunks and reupload it." %video
